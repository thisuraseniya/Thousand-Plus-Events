               ...
               <div class="col s12 m3">  
                ...
                <div class="col s12 m9" style="margin-top:30px">
                    ...
                    <div class="row"> 
                        ...
                        <a href="" class="breadcrumb">Logistics Department</a>                    
                    </div>
                                                 ...
                                                 <ul class="collection">     
                                                   <?php foreach($crew as $val){ ?>
                                                    ...
                                                    <li class="collection-item avatar">
                                                      ...
                                                      <a href="<?=base_url()?>index.php/home/delete_user_logistics/<?php echo $event_id."/".$val['username']    ; ?>" class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Remove user">remove</i></a>
                                                    </li>
                                    ...
                                    <div>                                        
                                        <div class="row">
                                            <div class="col s12">
                                                <ul class="collection">
                                                    <li class="collection-item avatar">
                                                    <i class="material-icons circle red">event_seat</i>
                                                        <span class="title">Venue</span>
                                                        <hr>
                                                        <div class="right-align">
                                                            <a href="<?=base_url()?>index.php/vendors?category=venue" class="btn blue waves-light waves-effect">Suggested</a> 
                                                            <a href="https://www.google.com/search?q=event+venues+around+me" target="_blank" class="btn green waves-light waves-effect">Web Search</a>
                                                        </div>
                                                    </li>     
                                                     <li class="collection-item avatar">
                                                    <i class="material-icons circle red">camera_alt</i>
                                                        <span class="title">Photographers</span>
                                                        <hr>
                                                        <div class="right-align">
                                                            <a href="<?=base_url()?>index.php/vendors?category=photography" class="btn blue waves-light waves-effect">Suggested</a> 
                                                            <a href="https://www.google.com/search?q=photographers+around+me" target="_blank" class="btn green waves-light waves-effect">Web Search</a>
                                                        </div>
                                                    </li>       
                                                     <li class="collection-item avatar">
                                                    <i class="material-icons circle red">fastfood</i>
                                                        <span class="title">Caterers</span>
                                                        <hr>
                                                        <div class="right-align">
                                                            <a href="<?=base_url()?>index.php/vendors?category=caterer" class="btn blue waves-light waves-effect">Suggested</a> 
                                                            <a href="https://www.google.com/search?q=caterers+around+me" target="_blank" class="btn green waves-light waves-effect">Web Search</a>
                                                        </div>
                                                    </li>       
                                                     <li class="collection-item avatar">
                                        ...
                                        <div class='col s12'>
                                                ...
                                                <?php foreach($tasks as $t){ ?>
                                                    ...
                                                    <li class="collection-item">
                                                        ...
                                                        <a href="<?=base_url()?>index.php/home/delete_task_logistics/<?php echo $event_id."/".$t['id']."/".$t['dept_id']; ?> " class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Remove task">remove</i></a>
                            ...
                            <table class="responsive-table highlight">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url()?>index.php/home/delete_transaction_logistics/<?= $event_id."/".($inc['id']*23)."/".$inc['type'] ?>" class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Delete Entry">remove</i></a></td>
                                    </tr>
...
<!--
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url()?>index.php/home/delete_transaction_logistics/<?= $event_id."/".($exp['id']*23)."/".$exp['type'] ?>" class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Delete Entry">remove</i></a></td>
                                    </tr>
                                    <?php 
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.ckbx').change(function(){
                ...
                $.ajax({
                     url:'<?=base_url()?>index.php/home/check_logistics',
                     method: 'post',
                     data: {id: id, value: value},
                     dataType: 'json',
                     complete: function(response){M.toast({html: 'Marked as ' + msg, displayLength: 2000 });}
                    });
            });
            ...
            $('.assigned_to').change(function(){               
                ...
                $.ajax({
                     url:'<?=base_url()?>index.php/home/assigned_to_logistics',
                     method: 'post',
                     data: {value: value},
                     dataType: 'json',
                     complete: function(response){M.toast({html: 'Task assigned to ' + name, displayLength: 2000 });}
                    });
            });
