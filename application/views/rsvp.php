           ...
           <div class="col s12 m3">  
            ...
            <div class="col s12 m9" style="margin-top:30px">
                ...
                <div class="row"> 
                    ...
                    <a href="<?php echo base_url(); ?>index.php/home/registrations/<?php echo $id_passed; ?>" class="breadcrumb">Registrations Department</a>                                 
        ...
        $(document).ready(function(){
            ...
            $('#send_emails').click(function(){
                ...
                else
                {
                    ...
                    $.ajax({
                         ...
                         method: 'post',
                         data: {emails: emails, id_passed: <?= $id_passed ?> },
                         dataType: 'json', 
                         complete:function(){                         
            ...
            $('#send_all_confirmed').click(function(){          
                ...
                $.ajax({
                     ...
                     method: 'post',
                     data: {event_id: event_id, id_passed: <?= $id_passed ?>},
                     dataType: 'json', 
                     complete:function(){                         
                         M.toast({html: 'Emails were successfully sent ', displayLength: 4000 });
