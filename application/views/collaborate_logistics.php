               ...
               <div class="col m3">  
                ...
                <div class="col m9" style="margin-top:30px">
                    ...
                    <div class="row"> 
                        ...
                        <a href="" class="breadcrumb"><?php echo $val['name']; ?> - Logistics Department</a>                    
                    </div>
                            ...
                            <table class="responsive-table highlight">
                                ...
                                <tbody>
                                   ...
                                   <tr>
                                        ...
                                        <td><a href="<?=base_url()?>index.php/collaborate/delete_transaction_logistics/<?= $event_id."/".($inc['id']*23)."/".$inc['type'] ?>" class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Delete Entry">remove</i></a></td>
                            ...
                            <table class="responsive-table highlight">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url()?>index.php/collaborate/delete_transaction_logistics/<?= $event_id."/".($exp['id']*23)."/".$exp['type'] ?>" class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Delete Entry">remove</i></a></td>
