               ...
               <div class="col m3">  
                ...
                <div class="col m9" style="margin-top:30px">
                    ...
                    <div class="row"> 
                        ...
                        <a href="" class="breadcrumb">Sales Department</a>                    
                    </div>
                                                 ...
                                                 <ul class="collection">     
                                                   <?php foreach($crew as $val){ ?>
                                                    ...
                                                    <li class="collection-item avatar">
                                                      ...
                                                      <a href="<?=base_url()?>index.php/home/delete_user_sales/<?php echo $event_id."/".$val['username']    ; ?>" class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Remove user">remove</i></a>
                                                    </li>
                                        ...
                                        <div class='col m12'>
                                                ...
                                                <?php foreach($tasks as $t){ ?>
                                                    ...
                                                    <li class="collection-item">
                                                        ...
                                                        <a href="<?=base_url()?>index.php/home/delete_task_sales/<?php echo $event_id."/".$t['id']."/".$t['dept_id']; ?> " class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Remove task">remove</i></a>
                            ...
                            <table class="responsive-table highlight">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url()?>index.php/home/delete_transaction_sales/<?= $event_id."/".($inc['id']*23)."/".$inc['type'] ?>" class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Delete Entry">remove</i></a></td>
                                    </tr>
                            ...
                            <table class="responsive-table highlight">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?=base_url()?>index.php/home/delete_transaction_sales/<?= $event_id."/".($exp['id']*23)."/".$exp['type'] ?>" class="secondary-content"><i class="material-icons red-text tooltipped" data-position="left" data-tooltip="Delete Entry">remove</i></a></td>
                                    </tr>
                                    <?php 
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.ckbx').change(function(){
                ...
                $.ajax({
                     url:'<?=base_url()?>index.php/home/check_sales',
                     method: 'post',
            ...
            $('.assigned_to').change(function(){               
                ...
                $.ajax({
                     url:'<?=base_url()?>index.php/home/assigned_to_sales',
                     method: 'post',
                     data: {value: value},
                     dataType: 'json',
